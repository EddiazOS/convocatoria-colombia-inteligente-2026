...
La ejecución del proyecto generará tres bloques de conocimiento científico-técnico directamente articulados con cada objetivo específico, constituyendo en conjunto una prueba de concepto analítica y computacional de nivel TRL 3 para el diseño racional de nanomateriales ricos en boro orientados al almacenamiento sólido y reversible de hidrógeno molecular.

#### Resultado 1: Base de datos cuántica para nanomateriales ricos en boro (OE1)

El cumplimiento del primer objetivo específico producirá un conjunto de conocimiento termodinámico de alta fidelidad sobre arquitecturas de metalacarboranos, borofenos y hojas de boro decoradas con metales de transición tempranos (Sc, Ti, V), que no existe actualmente en la literatura colombiana ni en repositorios internacionales con el nivel de rigor propuesto. Este conocimiento comprende:

- (i) Energías de adsorción de H₂ corregidas con ZPE y dispersión DFT-D3 para un mínimo de 200 configuraciones estructurales únicas, superando los sesgos de los funcionales GGA puros documentados en el estado del arte.
- (ii) Criterios de estabilidad del enlace dopante-sustrato (\(E_b > E_{cohesiva}\) del metal) que aportan una base más rigurosa para el modelado realista de nuevos materiales.
- (iii) Superficies de energía potencial (PES) muestreadas a alta temperatura mediante AIMD, que capturan la respuesta de los enlaces B-B, B-C y Met-H bajo estrés térmico.
...
El segundo objetivo generará conocimiento inédito sobre los límites, la precisión y la eficiencia de los modelos de grafos atómicos y potenciales interatómicos de redes neuronales cuando se aplican específicamente al espacio químico de las nanoestructuras ricas en boro para el almacenamiento de H₂, una familia de materiales que no cuenta con NNIPs especializados publicados a nivel internacional. Este conocimiento incluye:
...
- (iii) La determinación de los errores sistemáticos del modelo sustituto frente a DFT de referencia, con cuantificación de incertidumbre epistémica en las zonas del espacio químico de menor densidad de datos.

Este conocimiento metodológico es generalizable a otras familias de materiales funcionales y constituye una contribución diferencial a la comunidad colombiana de simulación computacional de materiales.
...
- (i) La determinación de la capacidad gravimétrica de almacenamiento reversible de H₂ (≥ 5,5 % en peso) bajo ciclos de carga y descarga simulados con dinámica molecular NNP en ensamble NPT, un resultado inalcanzable mediante DFT estático o AIMD convencional para esta familia de materiales.
...
- (iv) La evaluación de la compatibilidad de cada candidato con rutas de síntesis experimental documentadas (CVD, descarga en arco eléctrico y síntesis solvotérmica), que eleva los resultados computacionales al nivel de una prueba de concepto con viabilidad de escalamiento.

En conjunto, estos tres bloques de conocimiento conforman la base científica que justifica la inversión pública y orienta las fases experimentales futuras del programa de investigación en almacenamiento de hidrógeno verde en Colombia.
...
**Producto 6 — Proceso de Apropiación Social del Conocimiento (ASC).**

El proyecto desarrollará un proceso de Apropiación Social del Conocimiento en el escenario de información, consulta e involucramiento, conforme a la naturaleza del eje temático de Ciencia y Tecnologías Cuánticas. Este proceso se orientará a facilitar la comprensión social del problema energético abordado por el proyecto, promover el diálogo entre actores académicos y sociales, y construir condiciones para la valoración pública del conocimiento científico generado.

El proceso incluirá, como mínimo, los siguientes componentes articulados:

- **Componente 6A — Información y consulta con actores de la alianza y del territorio.** Se realizarán al menos dos (2) jornadas presenciales de información y consulta con actores vinculados al proyecto en el departamento de Bolívar, con participación de la organización local o regional aliada y otros grupos de interés pertinentes. Estas jornadas permitirán identificar percepciones, expectativas y necesidades frente a las tecnologías de almacenamiento de energía, así como socializar de manera comprensible los alcances, limitaciones e implicaciones del proyecto.
- **Componente 6B — Diálogo de saberes y sistematización colaborativa.** A partir de las jornadas anteriores, se desarrollará un ejercicio de intercambio de saberes y conocimientos orientado a reconocer las distintas visiones del territorio sobre transición energética, uso del conocimiento científico y apropiación de tecnologías emergentes. Los resultados del proceso serán sistematizados de manera colaborativa en formatos acordados con los participantes.
- **Componente 6C — Producto final de ASC.** Como resultado verificable, se entregará un producto de ASC que documente el proceso desarrollado, los actores participantes, la metodología implementada, los aprendizajes alcanzados y las posibilidades de continuidad o sostenibilidad territorial del ejercicio.

*Indicador verificable:* Un (1) producto de Apropiación Social del Conocimiento entregado y soportado metodológicamente antes del cierre del proyecto.
...
El principal mecanismo de sostenibilidad científica del proyecto es la publicación en acceso abierto de los productos de conocimiento que no estén sujetos a restricciones justificadas de propiedad intelectual, reserva legal o protección de datos. La base de datos DFT de alta fidelidad (Producto 1) será depositada en repositorios internacionales de acceso abierto, tales como Zenodo o Materials Cloud, bajo licencia Creative Commons CC-BY 4.0 o la que resulte jurídicamente procedente según la naturaleza final de los datos y la política institucional de propiedad intelectual. Los modelos GNN y NNP (Productos 2 y 3) serán publicados como software de código abierto en repositorios públicos con documentación técnica suficiente para su reutilización, extensión y validación por otros grupos de investigación.

Esta estrategia es coherente con las disposiciones de ciencia abierta de la convocatoria, según las cuales los resultados, productos, publicaciones y datos derivados de proyectos financiados con recursos públicos deben ponerse a disposición de la ciudadanía a través de infraestructuras y sistemas de información científicos estandarizados e interoperables, salvo que existan causales justificadas para restringir su acceso. En consecuencia, el proyecto adoptará un esquema de apertura progresiva de resultados, articulado con la estrategia de propiedad intelectual definida en la propuesta, con el fin de evitar afectaciones a la novedad de eventuales desarrollos susceptibles de protección.

La sostenibilidad de la línea de investigación se asegura mediante una hoja de ruta de financiación en múltiples horizontes temporales. En el corto plazo (0 a 12 meses posteriores al cierre), el equipo investigador someterá al menos dos artículos científicos a revistas indexadas, consolidando la visibilidad académica del proyecto y fortaleciendo las capacidades del grupo de investigación. En el mediano plazo (2 a 3 años posteriores al cierre), los candidatos computacionalmente validados constituirán la base técnica para formular una propuesta experimental orientada a avanzar hacia niveles TRL 4 a 5. En el largo plazo (más de 3 años), la existencia de un NNP especializado en nanomateriales ricos en boro posicionará al grupo investigador y a la alianza como referentes nacionales en simulación cuántica de materiales estratégicos para la transición energética.
...
El tercer nivel de transferencia opera a través de la estrategia de Apropiación Social del Conocimiento y divulgación pública de la ciencia definida en la sección 4.5.2. Dada la naturaleza del eje temático de Ciencia y Tecnologías Cuánticas, esta apropiación se estructura principalmente mediante acciones de información, consulta y divulgación, orientadas a acercar los fundamentos del proyecto a actores no especializados y a fortalecer la comprensión pública de sus implicaciones territoriales, científicas y tecnológicas.

Las jornadas de información y consulta con organizaciones y actores del territorio permitirán traducir los contenidos técnicos del proyecto a un lenguaje comprensible, recoger percepciones sobre necesidades energéticas locales y promover espacios de reflexión sobre el valor social de la ciencia y las tecnologías cuánticas. De manera complementaria, el ejercicio de diálogo de saberes y la sistematización colaborativa favorecerán la construcción de relaciones horizontales entre el equipo investigador y los actores participantes, en coherencia con los principios de lectura de contexto, participación y diálogo de saberes promovidos por MinCiencias.

La divulgación pública de la ciencia se implementará mediante contenidos multiformato orientados a públicos no especializados, con énfasis en la relevancia social del almacenamiento de energía, la modelación computacional y la transición energética. Estos contenidos visibilizarán el proceso investigativo, las comunidades vinculadas, los posibles impactos del proyecto y la utilidad pública del conocimiento generado, buscando fortalecer capacidades críticas y reflexivas sobre las relaciones entre ciencia, tecnología y sociedad.

Adicionalmente, el semillero de investigación participará activamente en actividades formativas y de comunicación del proyecto, en coherencia con las exigencias de la convocatoria. Su vinculación no solo fortalecerá la formación temprana en investigación, sino que contribuirá a la generación de productos de apropiación social del conocimiento, conforme a lo establecido para los semilleros en los términos de la convocatoria.
...
| 5.3 Producción y publicación de contenidos multiformato de divulgación pública de la ciencia |    |    |    | ●  | ●  | ●  | ●  | ●  | ●  |     |     |     |     |     |
